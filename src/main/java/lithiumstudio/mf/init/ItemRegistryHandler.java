...
public class ItemRegistryHandler
{
    ...
    public static final RegistryObject<Item> ITEM_FUR = REGISTRY.register("item_fur", BaseMineFurryItem::new);
    public static final RegistryObject<Item> ITEM_GLUE = REGISTRY.register("item_glue", BaseMineFurryItem::new);
    public static final RegistryObject<Item> ITEM_CLOTH = REGISTRY.register("item_cloth", BaseMineFurryItem::new);
    public static final RegistryObject<Item> DUCT_TAPE = REGISTRY.register("duct_tape", BaseMineFurryItem::new);
    ...
    public static final RegistryObject<Item> ITEM_FUR_FABRIC = REGISTRY.register("fur_fabric",BaseMineFurryItem::new);
