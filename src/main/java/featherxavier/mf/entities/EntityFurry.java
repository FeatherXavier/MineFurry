package featherxavier.mf.entities;
...
public class EntityFurry extends Animal
{
    ...
    {
        event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(EntityRegistryHandler.ENTITY_FURRY.get(), 1, 1, 2));
    }
